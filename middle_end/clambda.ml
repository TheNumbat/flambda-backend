...
type ustructured_constant =
  ...
  | Uconst_vec128 of Primitive.vec128_type * int64 * int64
...
let rank_structured_constant = function
  ...
  | Uconst_string _ -> 6
  | Uconst_closure _ -> 7
  | Uconst_vec128 (Int8x16, _, _) -> 8 
  | Uconst_vec128 (Int16x8, _, _) -> 9 
  | Uconst_vec128 (Int32x4, _, _) -> 10 
  | Uconst_vec128 (Int64x2, _, _) -> 11
  | Uconst_vec128 (Float32x4, _, _) -> 12
  | Uconst_vec128 (Float64x2, _, _) -> 13
...
let compare_structured_constants c1 c2 =
  ...
  | Uconst_vec128 (lty, l0, l1), Uconst_vec128 (rty, r0, r1)
    when Primitive.equal_vec128 lty rty -> 
